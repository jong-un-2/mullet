...
const App = () => {
    ...
    const getList = async (page) => {
        ...
        const rep = await getcollegelist(p)
        if (rep.code == 200) {
    ...
    const addqun = async () => {
        ...
        const rep = await collegeTypeadd(p)
        if (rep.code == 200) {
    ...
    const edit = async () => {
        ...
        const rep = await collegeTypeedit(p)
        if (rep.code == 200) {
    ...
    const deletequn = async () => {
        const rep = await deletecollegetype(chakanData?.id)
        if (rep.code == 200) {
