...
import { Card, Form, InputNumber, Button, Space, message, Divider, Switch, Alert, Input, Tabs } from 'antd';
import { SaveOutlined, ReloadOutlined, WalletOutlined, SettingOutlined } from '@ant-design/icons';
