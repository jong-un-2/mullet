...
```bash
# 初次上传
anchor idl init -f target/idl/mars.json Dfr6zir7nV2DWduqhtHNdkJn4mMxHf9G8muQSatiZ1k9

# 更新 IDL
anchor idl upgrade -f target/idl/mars.json Dfr6zir7nV2DWduqhtHNdkJn4mMxHf9G8muQSatiZ1k9
```
...
# 下载我们的合约 IDL
anchor idl fetch -o ./downloaded-idl.json Dfr6zir7nV2DWduqhtHNdkJn4mMxHf9G8muQSatiZ1k9
```
...
solana-verify verify-from-repo \
  --remote \
  --program-id Dfr6zir7nV2DWduqhtHNdkJn4mMxHf9G8muQSatiZ1k9 \
...
#### Solana.fm
```
https://solana.fm/address/Dfr6zir7nV2DWduqhtHNdkJn4mMxHf9G8muQSatiZ1k9?cluster=mainnet-alpha
```

#### Solscan
```
https://solscan.io/account/Dfr6zir7nV2DWduqhtHNdkJn4mMxHf9G8muQSatiZ1k9
```

#### SolanaFM Explorer
```
https://explorer.solana.com/address/Dfr6zir7nV2DWduqhtHNdkJn4mMxHf9G8muQSatiZ1k9
```
...
curl https://verify.osec.io/status/Dfr6zir7nV2DWduqhtHNdkJn4mMxHf9G8muQSatiZ1k9
```
