				...
				<Box sx={{ pt: 2 }}>
					...
					<Button
						...
						sx={{
							...
							mb: 3,
							justifyContent: 'space-between',
							border: isBaseTokenStable ? '2px solid #dc2626' : '1px solid rgba(255, 255, 255, 0.2)',
							backgroundColor: isBaseTokenStable ? 'rgba(239, 68, 68, 0.1)' : 'rgba(255, 255, 255, 0.05)',
							color: '#ffffff',
							'&:hover': {
								backgroundColor: isBaseTokenStable ? 'rgba(239, 68, 68, 0.15)' : 'rgba(255, 255, 255, 0.1)'
							},
						}}
