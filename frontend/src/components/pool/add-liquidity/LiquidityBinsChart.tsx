							...
							<Box
								...
								sx={{
									...
									background: isActive
										...
										: isHovered
										? 'linear-gradient(to top, #3b82f6 0%, #1e40af 100%)'
										: isSelected
								...
								<Box key={i} sx={{ 
									...
									<Box sx={{ 
										...
										<Typography 
											variant="caption" 
											sx={{ 
												color: isCurrentPrice ? '#3b82f6' : 'rgba(120, 113, 108, 0.7)',
												fontSize: isCurrentPrice ? '0.65rem' : '0.6rem',
												fontWeight: isCurrentPrice ? 600 : 500,
												textAlign: 'center',
												whiteSpace: 'nowrap',
												letterSpacing: '0.02em',
												background: isCurrentPrice ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
										...
										{!isCurrentPrice && (
											<Typography 
												...
												sx={{
													fontSize: '0.5rem',
													fontWeight: 500,
													color: percentChange > 0 ? '#3b82f6' : '#10b981',
													textAlign: 'center',
													whiteSpace: 'nowrap',
												}}
											>
