...
import PrivyWalletConnector from '../components/PrivyWalletConnector';
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 3 }}>
                  <Box>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      <Typography variant="body1" fontFamily="monospace" sx={{ color: '#94a3b8' }}>
                        {address}
                      </Typography>
                      <IconButton size="small" onClick={() => copyToClipboard(address!)} sx={{ color: '#3b82f6' }}>
                        <CopyIcon />
                      </IconButton>
                    </Box>
