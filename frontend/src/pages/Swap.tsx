      ...
      <Box sx={{ position: 'relative', zIndex: 1 }}>
        ...
        <Container maxWidth="sm" sx={{ py: 4 }}>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <IconButton onClick={() => setShowSettings(true)} sx={{ color: '#94a3b8' }}>
                <SettingsIcon />
              </IconButton>
            </Box>
        ...
        >
          <DialogTitle sx={{ color: '#ffffff' }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              Select a token
              <IconButton onClick={() => setIsTokenSelectOpen(false)} sx={{ color: '#94a3b8' }}>
                <CloseIcon />
              </IconButton>
            </Box>
          </DialogTitle>
        ...
        >
          <DialogTitle sx={{ color: '#ffffff' }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              Settings
              <IconButton onClick={() => setShowSettings(false)} sx={{ color: '#94a3b8' }}>
                <CloseIcon />
              </IconButton>
            </Box>
          </DialogTitle>
